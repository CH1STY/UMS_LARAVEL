...
@section('container')
<h2 align="center" style="padding:2%">COURSE LIST FOR UPLOADING NOTICES</h2>
<table class="table tableCustom" align="center">
    ...
    <tbody>
        ...
        <tr>
            ...
            @endif
            <td><a href="{{route('teacher.noticeUpload',['id'=>$list->course_id])}}">
                <button class="btn btn-primary">Upload Notice</button></a></td>
        </tr>
