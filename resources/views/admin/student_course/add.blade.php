...
@section('container')
<h1 align="center">Adding Student To Course</h1>
...
<form action="" method="post">
    ...
    <table class="table formTable">
        ...
        <tr>
            ...
            <td>
                <select style="widht:200px;" name="course_id" id="course_box">
...
$(document).ready(function() {
    ...
    function updateCourseList()
    {
        ...
        $.ajax({
                   ...
                   url: "{{route('admin.student.course.fetch')}}"+"?student_id="+student_id,
