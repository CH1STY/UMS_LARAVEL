...
@if($ad)
     ...
     <table class="table formTable">
         ...
         <tr>
             ...
             <td style="font-weight: 700;">{{$ad->account_id}}</td>
         </tr>
         <tr>
 ...
 <div class="buttonDiv">
    <a href="{{route('admin.edit.teacher',['t_id'=>$ad->id,])}}"><button align="center" class="btn btn-success">Edit</button></a>
</div>

 @else
    <h3 style="text-align: center;color:red" > Account ID Error!</h3>
 @endif
